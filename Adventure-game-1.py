...
class spelare():
    ...
    def lvl_up():
        ...
        print(f"du levlade upp: [STR {Gamer_attribute.strength}] [LVL {Gamer_attribute.lvl}], [HP {Gamer_attribute.hp}] \n EXP: {Gamer_attribute.exp}")
...
Gamer_attribute = spelare(spelare_namn, 50, 50, 9,[], 0, 1)
